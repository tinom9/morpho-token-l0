...
Morpho token contracts for spoke networks (non-Ethereum networks), and OFT adapters.
...
Currently, for Ethereum and HyperEVM. To be updated with Arbitrum addition.
...
pnpm hardhat lz:deploy --networks hyperevm --tags MorphoToken --ci
pnpm hardhat lz:deploy --networks hyperevm --tags MorphoMintBurnOFTAdapter --ci

pnpm hardhat lz:grant-mint-burn-roles --networks hyperevm

pnpm hardhat lz:set-rate-limits --networks ethereum,hyperevm
